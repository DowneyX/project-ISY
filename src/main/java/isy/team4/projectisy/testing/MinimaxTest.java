...
public class MinimaxTest implements IGameObserver {
    ...
    public void setup() {
        ...
        ruleset = new OthelloRuleSet();

        players[0] = new AIPlayer("player1");
        players[1] = new AIPlayer("player2");
        players[0].setRuleSet(ruleset);
        players[1].setRuleSet(ruleset);
    ...
    public void onFinished() {
        this.update("Finished: " + this.localgame.getResult().toString());
    }

    @Override
    public void onIllegal() {
        this.update("illegal: " + this.localgame.getCurrentPlayer());
    }
    ...
    public void update(String msg) {
        ...
        if(ruleset.isDraw() || ruleset.isWon()) {
            try {
                fileWriter.close();
            } catch(Exception e) {
